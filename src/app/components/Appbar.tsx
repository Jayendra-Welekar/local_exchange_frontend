  ...
  return (
    <div className="z-10 fixed top-0 w-full h-14 flex flex-row justify-between items-center pl-[21px] pr-4 box-border p-2  bg-[#0E0F14] text-white">
      ...
      <div id="search-bar">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-search h-4 w-4 text-slate-400"><circle cx="11" cy="11" r="8"></circle><path d="m21 21-4.3-4.3"></path></svg>
